...
RcppExport SEXP _rayvertex_prepare_scene_rcpp(SEXP sceneSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::List >::type scene(sceneSEXP);
    rcpp_result_gen = Rcpp::wrap(prepare_scene_rcpp(scene));
    return rcpp_result_gen;
END_RCPP
}
// prepared_scene_snapshot
Rcpp::List prepared_scene_snapshot(SEXP handle);
RcppExport SEXP _rayvertex_prepared_scene_snapshot(SEXP handleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type handle(handleSEXP);
    rcpp_result_gen = Rcpp::wrap(prepared_scene_snapshot(handle));
    return rcpp_result_gen;
END_RCPP
}
// prepared_scene_info
Rcpp::List prepared_scene_info(SEXP handle);
RcppExport SEXP _rayvertex_prepared_scene_info(SEXP handleSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type handle(handleSEXP);
    rcpp_result_gen = Rcpp::wrap(prepared_scene_info(handle));
    return rcpp_result_gen;
END_RCPP
}
// prepared_scene_lifetime
Rcpp::List prepared_scene_lifetime();
RcppExport SEXP _rayvertex_prepared_scene_lifetime() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    rcpp_result_gen = Rcpp::wrap(prepared_scene_lifetime());
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rayvertex_prepare_scene_rcpp", (DL_FUNC) &_rayvertex_prepare_scene_rcpp, 1},
